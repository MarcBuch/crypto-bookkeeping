...
2. Run the repo script from the repository root:

```bash
bun run scripts/create-worktree.ts <branch-name> [worktree-name]
```
...
- Do not manually duplicate the script behavior unless the script itself is broken.
